...
const Client = () => {
    ...
    return (
        <Container>
            ...
            <Row>
            <Col  xs={12} md={4}>
                        <img src={`https://www.themoviedb.org/t/p/w300_and_h450_bestv2/${movieSerchL.poster_path}`} alt={movieSerchL.original_title} />
                        <p style={{ color: 'black' }}>{movieSerchL.original_title}</p>
                    </Col>
            </Row>
